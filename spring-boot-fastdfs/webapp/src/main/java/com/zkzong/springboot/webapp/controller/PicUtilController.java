package com.zkzong.springboot.webapp.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.zkzong.springboot.neo4j.domain.Picture;
import com.zkzong.springboot.neo4j.model.PictureQo;
import com.zkzong.springboot.neo4j.service.PictureService;
import com.zkzong.springboot.webapp.service.AsyncThreadPool;
import com.zkzong.springboot.webapp.service.FastefsClient;
...
public class PicUtilController {
    @Value("${file.path.head:http://192.168.3.2:80/}")
