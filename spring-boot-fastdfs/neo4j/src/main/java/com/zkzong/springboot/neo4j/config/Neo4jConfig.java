package com.zkzong.springboot.neo4j.config;
...
@EnableNeo4jRepositories(basePackages = {"com.zkzong.springboot.neo4j.repositories"})
...
//    }
    ...
    public SessionFactory getSessionFactory() {
        return new SessionFactory("com.zkzong.springboot.neo4j.domain");
    }
}
